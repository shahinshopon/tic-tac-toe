                            ...
                            GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  ...
                                  child: Container(
                                    decoration: const BoxDecoration(image: DecorationImage(image: AssetImage("assets/images/grid_box.png"), fit: BoxFit.fill)),
                                    child: buttons[index]['state'] == ""
                                        ? Container()
                                        : Image.asset(
                                            u.returnImage(index, buttons, widget.player2Skin, widget.player1Skin),
                                          ),
                                  ),
                                );
                              },
