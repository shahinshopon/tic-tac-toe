...
// class _SinglePlayerScreenActivityState extends State<SinglePlayerScreenActivity> with ChangeNotifier {
...
//         if (buttons[utils.winningCondition[j][0]]["player"] == buttons[utils.winningCondition[j][1]]["player"] &&
//             buttons[utils.winningCondition[j][1]]["player"] == buttons[utils.winningCondition[j][2]]["player"] &&
...
//                                 currentMove != utils.getTranslated(context, "doraTurn")
//                                     ? Dialoge.winner(context, utils.getTranslated(context, "dora"), "", "", "", "")
//                                     : Dialoge.winner(context, "$_username", "", "", "", "");
//                                 setState(() {});
//                               },
//                             ),
//                             Padding(
...
//                                         ? Container()
//                                         : Image.asset(
//                                             utils.returnImage(i, buttons, widget.playerSkin, widget.doraSkin),
//                                           ),
//                                   ),
//                                 );
//                               },
...
//                           ],
//                         ),
//                         Expanded(child: Image.asset("assets/images/vs_small.png")),
//                         Row(
//                           children: [
//                             Column(
