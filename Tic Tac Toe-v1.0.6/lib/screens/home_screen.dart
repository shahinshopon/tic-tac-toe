...
//   List<Item> itemList = [
//     Item(icon: "assets/images/offline_white.png", name: "OFFLINE PLAY", desc: "Play with the Clever Fox DORA"),
//     Item(icon: "assets/images/play_random.png", name: "PLAY WITH RANDOM", desc: "Find your match around the world"),
//     Item(icon: "assets/images/passnplay_white.png", name: "PASS N PLAY", desc: "Pass N Play With your Friend"),
//   ];
...
//         ),
//         Item(icon: "assets/images/play_random.png", name: utils.getTranslated(context, "PLAY_WITH_RANDOM"), desc: utils.getTranslated(context, "Find_your_match_around_the_world")),
//         Item(
...
//                   child: SlideTransition(position: doraAnimation, child: Image.asset("assets/images/welcome_dora.png"))),
//               GestureDetector(
...
//                 ElevatedButton.icon(
//                     style: ButtonStyle(
//                         backgroundColor: MaterialStateProperty.all(back), shape: MaterialStateProperty.all(const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(20.0))))),
//                     onPressed: () async {
//                       music.play(click);
//                       try {
...
//                             CupertinoPageRoute(
//                                 builder: (context) =>
//                                     PassNPLay("${utils.limitChar(player1controller.text.toString(), 7)}", "${utils.limitChar(player2controller.text.toString(), 7)}", userSkin, opponentSkin)));
//                       }
//                     },
//                     icon: Icon(
//                       Icons.skip_next,
...
//                   ),
//                 ),
//                 avatar: widget.avtar ? Image.asset("assets/images/coin_symbol.png") : null,
//               ),
//             );
//           }),
//     );
...
class HomeScreenActivityState extends State<HomeScreenActivity> with TickerProviderStateMixin {
  ...
  Utils localValue = Utils();
   String userSkin, opponentSkin;
   AnimationController firstAnimationController;

   String clickAudioUrl;
  ...
  TextEditingController player2controller = TextEditingController();
   ...
   Animation<Color> topSwipeColor;

   Animation<Color> bottomSwipeColor;

   Animation<double> topAngle;
   Animation<double> bottomAngle;
   Animation<double> centerTopAngle;
   Animation<double> centerBottomAngle;

   Animation<Alignment> topCenterContainerAlignment;

   Animation<Alignment> centerBottomContainerAlignment;

   Animation<Alignment> bottomCenterContainerAlignment;

   Animation<Alignment> centerTopContainerAlignment;

   Animation<double> topLastContainerOpacityAnimation;
   Animation<double> lastTopContainerOpacityAnimation;

   Animation<Offset> doraAnimation;
   Animation<Offset> leftAnimation;
  bool swipeUP = false;
   AnimationController centerAnimationController;
  String getlanguage;
