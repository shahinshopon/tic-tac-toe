...
class _MoreGamesListingState extends State<MoreGamesListing> {
  ...
  List<HTMLGames> gamesList = [
    HTMLGames(
        gameImage: 'https://firebasestorage.googleapis.com/v0/b/tictact-a37a5.appspot.com/o/More%20game%20images%2Fhextris.webp?alt=media&token=302e901c-6c88-478f-bb0b-2736ed6e34ab',
        gameName: 'Hextris',
    ...
    HTMLGames(
        gameImage: 'https://firebasestorage.googleapis.com/v0/b/tictact-a37a5.appspot.com/o/More%20game%20images%2Fpacman-html5-canvat.webp?alt=media&token=94941943-d863-4dbf-9467-a7fb53819c3f',
        gameName: 'Pacman',
        ...
        children: [
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Text(
                          game.gameName,
                          style: Theme.of(context).textTheme.titleMedium.copyWith(color: primaryColor, fontWeight: FontWeight.bold, letterSpacing: 1.2),
                        ),
                      ),
                    ),
                  ),
          ...
          InkWell(
            child: Container(
                ...
                decoration: BoxDecoration(color: red, borderRadius: BorderRadius.all(Radius.circular(10))),
                child: Center(
                    child: Text(
...
class HTMLGames {
  ...
  HTMLGames({@required this.gameName, @required this.gameImage, @required this.gameURL});
}
