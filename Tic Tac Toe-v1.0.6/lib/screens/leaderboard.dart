...
class _LeaderBoardScreenState extends State<LeaderBoardScreen> {
  ...
  Future<List<Map>> leaderBoard() async {
    ...
    DatabaseEvent snapshot = await db.ref().child("users").orderByChild("score").once();
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [Image.asset("assets/images/leaderboard_white.png"), Text(" ${utils.getTranslated(context, "leaderboard")}")],
          ),
          centerTitle: true,
          actions: [
            IconButton(
            ...
            Column(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: primaryColor, borderRadius: const BorderRadius.only(bottomLeft: Radius.circular(40), bottomRight: Radius.circular(40))),
                  child: Column(
                    children: [
                      Center(
                        child: Column(
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.only(start: 30.0, end: 30.0, bottom: 0, top: 10.0),
                        child: Row(
                  ...
                  child: Container(
                    ...
                    child: FutureBuilder<List<Map>>(
                        ...
                        builder: (context, snapshot) {
                                          ...
                                          child: ListTile(
                                            ...
                                            leading: Row(
                                              ...
                                              children: [
                                                ...
                                                CircleAvatar(
                                                  backgroundColor: primaryColor,
                                                  backgroundImage: NetworkImage(data[i]["profilePic"] == null ? guestProfilePic : data[i]["profilePic"]),
                                                  radius: 25,
                                                ),
                                              ],
                                            ),
                          ...
                          return Container(
                            child: Text(utils.getTranslated(context, "noDataFound")),
                          );
                        }),
                  ),
                )
  ...
  overlayEntry = OverlayEntry(
      builder: (context) => Positioned.directional(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(color: white, borderRadius: BorderRadius.circular(5.0)),
            child: Padding(
              padding: EdgeInsets.all(5.0),
              child: Text(
                utils.getTranslated(context, "lowScore"),
                style: TextStyle(color: primaryColor, fontSize: 12, decoration: TextDecoration.none),
              ),
            ),
          )));
