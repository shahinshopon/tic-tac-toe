...
//                                     backgroundColor: Colors.transparent,
//                                     radius: 50,
//                                     backgroundImage: (pic == "" ? AssetImage("assets/images/dora_win.png") : NetworkImage(pic!)) as ImageProvider<Object>?))),
//                       ),
//                       Padding(
//                         padding: const EdgeInsets.all(8.0),
//                         child: Text(
//                           "$playerName" + " " + utils.getTranslated(context, "win"),
//                           style: Theme.of(context).textTheme.titleLarge!.copyWith(color: white, fontWeight: FontWeight.bold, fontSize: 14),
...
//                               ),
//                               avatar: Image.asset("assets/images/coin_symbol.png"),
//                             )
//                           : Container(),
//                       Align(
...
//   tie(BuildContext context, String fromScreen, [player1name, player2name, player1skin, player2skin, levelType]) {
//     utils.alert(
...
//                     ? Navigator.pushReplacement(context, CupertinoPageRoute(builder: (BuildContext context) => SinglePlayerScreenActivity(player1skin, player2skin, levelType)))
//                     : Navigator.pushReplacement(context, CupertinoPageRoute(builder: (BuildContext context) => PassNPLay(player1name, player2name, player1skin, player2skin)));
//               },
//               child: Text(utils.getTranslated(context, "restart"), style: TextStyle(color: white)),
//             ),
//           )
//         ]);
//   }
...
//       FirebaseDatabase.instance.ref().child(parentNode).child(childNode!).remove();
//     });
//   }
// }
